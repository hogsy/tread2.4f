...
int CHalfLifeMapFile::ReadEntity(CEntity** ppEntity, CTread3DDoc* pDocument,
                                 CTokenizer& Tokenizer) {
  int r = CQuakeMapFile::ReadEntity(ppEntity, pDocument, Tokenizer);
  if (r != QRF_WORLDSPAWN) return r;
...
bool CHalfLifeMapFile::WriteFace(CFace* pFace, CTread3DDoc* pDocument,
                                 std::fstream& file) {
  int i;
  // Just skip.
...
bool CHalfLifeMapFile::WriteWorldspawn(
